...
import { FormControlLabel, FormGroup, Icon, Switch, Tooltip } from '@mui/material';
      ...
      <div className="editor-main-column">
        ...
        */}
          <div className="editor-main-column-header-controls">
            ...
            <Tooltip title={<T>
              This text will be used as a default input to the model every time the noggin is used. If you do not include any text for this input, it will be left blank unless your code using this noggin provides a value.
            </T>}>
              <HelpIcon color="action" />
            </Tooltip>
          </div>
        ...
        <div className="editor-main-column-header">
          <div className="editor-main-column-header-title">
            ...
            <Tooltip title={<T>
              ...
              <p>The chat prompt is the main input to the model. It can contain instructions, information, and relevant prior context.</p>
              <p>Typically, the last item in a prompt is a &ldquo;User&rdquo; section, representing the current query. The model will always respond with an &ldquo;Assistant&rdquo; section.</p>
              <p>Even if you are not building a chatbot, you can use the chat format to delineate &rdquo;turns&ldquo; taken by the system. &ldquo;User&rdquo; sections do not need to be formatted as natural-language questions.</p>
              <p>Many of the highest-quality large language models are available only in chat format, so it can be valuable to use chat prompts even if your prompt only ever consists of a single &ldquo;User&rdquo; turn.</p>
            </T>}>
              <HelpIcon color="action" />
            </Tooltip>
          </div>
